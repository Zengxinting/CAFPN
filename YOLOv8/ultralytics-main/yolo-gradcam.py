...
def get_params():
    params = {
        'weight': '/media/zxt/文档/PycharmProject/2detection/yolo11/runs/对比实验/demo8_VEDAI/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/media/zxt/Elements/zxt/VEDAI/images/00000286.png', 'result')